...
def main_page(request):
    return render(request, 'PyramidWebConnector/main.html')

# Products View
def products_view(request):
    products.run_import()
    return render(request, 'PyramidWebConnector/products_view.html')
...
def orders_view(request):
    if request.method == "POST":
        orders.run_import()
    return render(request, 'PyramidWebConnector/orders_view.html')
...
def categories_view(request):
    ...
    return render(request, 'PyramidWebConnector/categories_view.html')
...
def image_view(request):
    ...
    return render(request, 'PyramidWebConnector/image_view.html')

def balance_view(request):
    if request.method == "POST":
        balance.run_import()
    return render(request, 'PyramidWebConnector/balance_view.html')
...
#    return render(request, 'PyramidWebConnector/orders_form.html')
...
def answer_form_view(request):
    ...
    return render(request, 'PyramidWebConnector/answer_form.html', {'form': form})
